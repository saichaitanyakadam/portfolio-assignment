    ...
    <div className="px-10 lg:px-[130px] mt-20" id="projects">
      ...
      <div className="flex flex-col lg:gap-10">
        {projectsArr.map((project, index) => (
          ...
          >
            <div
              className={`w-full lg:w-[50%] lg:justify-self-cente lg:self-center px-10 lg:px-[80px] flex flex-col  gap-6 ${
                index % 2 === 0 ? "" : "lg:order-1"
              }`}
            >
              <h3 className="text-[40px] font-bold">{project.projectName}</h3>
